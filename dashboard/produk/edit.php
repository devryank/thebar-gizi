                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" value="<?= $row['nama']; ?>" placeholder="Ciki Taro">
                        </div>
                        <div class="mb-3">
                            <img width="200px" src="<?= $base_url; ?>/assets/img/<?php echo $row['kategori'] . "/" . $row['foto'] ?>" alt="">
                            <br>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="harga" value="<?= $row['harga']; ?>" placeholder="2000">
                        </div>
                        <div class="mb-3">
